...
d2 = 1; %rate of decay of drug (1/day)
...
k1 = 0.2; %drug toxicity to immune cells %k values chosen for ideal conditions
...
ylabel('Fu(Per tumor cell kill rate)');
hold on
...
hold on
xlabel('Amount of Drug');
ylabel('Fu(Per normal cell kill rate)');
...
xlabel('Amount of Drug');
ylabel('Fu(Per immune cell kill rate)');
